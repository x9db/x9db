...
def ping_ip(ip_address):
    try:
        ...
        print(Colorate.Horizontal(Colors.purple_to_blue, "Timeout expired. No response received."))
    except Exception as e:
        print(Colorate.Horizontal(Colors.purple_to_blue, f"An error occurred: {e}"))
...
def get_ip_information(ip_address):
    try:
        ...
        for key, value in info_to_display.items():
            if value:
                print(Colorate.Horizontal(Colors.purple_to_blue, f"{key}: {value}"))
...
def port_scan(ip_address):
    open_ports = []
    print(Colorate.Horizontal(Colors.purple_to_blue, f"Scanning ports on {ip_address}... This may take a while."))
...
def main_menu():
    print(Colorate.Horizontal(Colors.purple_to_blue, '1) Ping IP'))
    print(Colorate.Horizontal(Colors.purple_to_blue, '2) IP Information'))
    print(Colorate.Horizontal(Colors.purple_to_blue, '3) Traceroute'))
    print(Colorate.Horizontal(Colors.purple_to_blue, '4) Reverse DNS Lookup'))
    print(Colorate.Horizontal(Colors.purple_to_blue, '5) Port Scan'))
    print(Colorate.Horizontal(Colors.purple_to_blue, '6) Whois Lookup'))
    print(Colorate.Horizontal(Colors.purple_to_blue, '7) Blacklist Check'))
    print(Colorate.Horizontal(Colors.purple_to_blue, '8) Exit'))
...
Made By x9db
    ...
    """
    colored_ascii = Colorate.Horizontal(Colors.purple_to_blue, ascii_art)
    print(Center.XCenter(colored_ascii))

    while True:
        main_menu()
        option = input(Colorate.Horizontal(Colors.purple_to_blue, "\nEnter your choice: "))

        if option == "1":
            ip_address = input(Colorate.Horizontal(Colors.purple_to_blue, "Enter IP address to ping: "))
            ping_ip(ip_address)
        elif option == "2":
            ip_address = input(Colorate.Horizontal(Colors.purple_to_blue, "Enter IP address to get information: "))
            get_ip_information(ip_address)
        elif option == "3":
            ip_address = input(Colorate.Horizontal(Colors.purple_to_blue, "Enter IP address for traceroute: "))
            traceroute_ip(ip_address)
        elif option == "4":
            ip_address = input(Colorate.Horizontal(Colors.purple_to_blue, "Enter IP address for reverse DNS lookup: "))
            reverse_dns_lookup(ip_address)
        elif option == "5":
            ip_address = input(Colorate.Horizontal(Colors.purple_to_blue, "Enter IP address for port scan: "))
            port_scan(ip_address)
        elif option == "6":
            ip_address = input(Colorate.Horizontal(Colors.purple_to_blue, "Enter IP address for whois lookup: "))
            whois_lookup(ip_address)
        elif option == "7":
            ip_address = input(Colorate.Horizontal(Colors.purple_to_blue, "Enter IP address for blacklist check: "))
            blacklist_check(ip_address)
        elif option == "8":
            print(Colorate.Horizontal(Colors.purple_to_blue, "Exiting program..."))
            os.system("python ./main.py")
        else:
            print(Colorate.Horizontal(Colors.purple_to_blue, "Invalid option. Please choose a number from 1 to 8."))
