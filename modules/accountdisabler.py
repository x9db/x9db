...
def accountdisablertitle():
    print("Account Disabler")  # Define this function to print a header or title
...
# You need a main function or equivalent to call disable(), or simply call disable() as it is the main function here
